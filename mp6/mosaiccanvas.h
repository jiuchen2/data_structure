...
class MosaicCanvas
{
  public:
     ...
     */
    MosaicCanvas(int theRows, int theColumns, vector<TileImage> const * v);
     ...
     */
    // void setTile(int row, int column, TileImage const * img);
    void setTile(int row, int column, unsigned img);
    /**
