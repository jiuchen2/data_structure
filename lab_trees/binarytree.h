...
class BinaryTree
{
  ...
  private:
     ...
     */
    /**
     *Private helper function for the public mirror fucntion.
     *@param subRoot The current node in the recursion
     */
    void mirror(Node* subRoot);

    /**
     *Private helper function for the public isOrdered fucntion.
     *@param subRoot The current node in the recursion
     *@return True if an in-order traversal of the tree would produce a
    ...
    /**
     *Private helper function for the public printPaths fucntion.
     *@param paths vector of vectors that contains path of nodes
     *@param path vector of previous nodes' elem
     *@param subRoot The current node in the recursion
     */
    void printPath(vector<vector<T> > &paths, vector<T> path, Node* subRoot) const;

    /**
     *Private helper function for the public sumDistances fucntion.
     *@param sum number of total distance
     *@param presum number of previous nodes
     *@param subRoot The current node in the recursion
     */
    void sumDistances(int &sum, int presum, Node* subRoot) const;
